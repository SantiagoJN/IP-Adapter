...
class StableDiffusionXLControlNetInpaintPipeline(
    ...
    def prepare_mask_latents(
        ...
        print(f'XL++++Function prepare_mask_latents. Inputs:\n\tmask: {mask.shape}\n\tmasked_image: {masked_image.shape}')
    ...
    def __call__(
        ...
        **kwargs,
        ...
        print(f'Before preparing mask. mask_image: {np.array(mask_image).shape}')
        # 5.3 Prepare mask
        mask = self.mask_processor.preprocess(
            mask_image, height=height, width=width, resize_mode=resize_mode, crops_coords=crops_coords
        )
        print(f'After preparing mask. mask: {mask.shape}')
        ...
        print(f'Before preparing mask latents')
        ...
        print(f'After preparing mask latents')
        print(f'\tmask: {mask.shape}')
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                print(f'Mask before chunking: {mask.shape}')
                if num_channels_unet == 4:
                    ...
                    print(f'-----Inside the __call__ function of XL pipeline-----')
